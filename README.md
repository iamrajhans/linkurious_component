...
Component to load the data from linkurious lib
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> linkurious-component -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import linkurious-component to your layout, then run it:
